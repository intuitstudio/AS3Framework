package com.intuitStudio.drawAPIs.concretes.flash3D
{
	...
	public class RingGrid extends CylinderGrid
	{
		protected var _radiusIn:Number;
		public function RingGrid (radius:Number=100,radiusIn:Number=80,cols:int=1,rows:int=1,size:Number=1)
		{
			_radiusIn = radiusIn;

package com.intuitStudio.motions.biDimen.core
{
	...
	public class MoveEntity extends BaseParticle implements IMovable
	{
		...
		public function MoveEntity(x:Number = 0, y:Number = 0, w:Number = -1, h:Number = -1)
		{
			super(x, y);
			_width = w;
			_height = h;

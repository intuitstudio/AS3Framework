package com.intuitStudio.ui
{
	...
	public class SimpleSlider extends Sprite
	{
		...
		private function init():void
		{
			...
			_handle = new Sprite();
			addChild(_handle);
			_handle.addEventListener(MouseEvent.MOUSE_DOWN, onStartSlider);
		...
		private function onStopSlider(event:MouseEvent):void
		{
			stage.removeEventListener(MouseEvent.MOUSE_MOVE, onUpdateSlider);
			stage.removeEventListener(MouseEvent.MOUSE_UP, onStopSlider);
			_handle.stopDrag();
		}
		
		private function onStartSlider(event:MouseEvent):void
		{
			stage.addEventListener(MouseEvent.MOUSE_MOVE, onUpdateSlider);
			stage.addEventListener(MouseEvent.MOUSE_UP, onStopSlider);
			_handle.startDrag(false, new Rectangle(0, 0, 0, _height - _handleHeight));
		}
		
		private function onUpdateSlider(event:MouseEvent):void
		{
			updateValue();
		}
		...
		public function dispose():void
		{
			stage.removeEventListener(MouseEvent.MOUSE_MOVE, onUpdateSlider);
			stage.removeEventListener(MouseEvent.MOUSE_UP, onStopSlider);
			_handle.removeEventListener(MouseEvent.MOUSE_DOWN, onStartSlider); 
		}
	}
}
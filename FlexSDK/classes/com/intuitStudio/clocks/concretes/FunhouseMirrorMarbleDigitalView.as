package com.intuitStudio.clocks.concretes
{
	...
	import com.intuitStudio.clocks.concretes.MarbleBeveledDigitalView;
	...
	public class FunhouseMirrorMarbleDigitalView extends MarbleBeveledDigitalView
	{
		...
		public function FunhouseMirrorMarbleDigitalView (model:ClockData,controller:ClockController,size:Number,color:uint=0,fontSize=36,fontFamily:String='Impact')
		{

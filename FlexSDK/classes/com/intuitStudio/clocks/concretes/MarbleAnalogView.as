package com.intuitStudio.clocks.concretes
{
	...
	public class MarbleAnalogView extends SimpleAnalogView
	{
		...
		public function MarbleAnalogView (model:ClockData,controller:ClockController,size:Number,color:uint=0,fontSize:int=36,fontFamily:String='Impact')
		{

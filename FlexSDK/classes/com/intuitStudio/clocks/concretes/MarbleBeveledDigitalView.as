package com.intuitStudio.clocks.concretes
{
	...
	import com.intuitStudio.clocks.concretes.BeveledDigitalView;
	import com.intuitStudio.utils.ImageUtils;
	import aether.textures.natural.MarbleTexture;


	public class MarbleBeveledDigitalView extends BeveledDigitalView
	{
		...
		public function MarbleBeveledDigitalView (model:ClockData,controller:ClockController,size:Number,color:uint=0,fontSize=36,fontFamily:String='Impact')
		{
